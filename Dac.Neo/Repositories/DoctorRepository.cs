...
public class DoctorRepository : IDoctorRepository
{
    ...
    /// </summary>
    public async Task<string> UpdateDoctor(string id,DoctorDB doctor)
    {
    ...
    /// <summary>
    /// Get doctor's pending Action Requests from Patients 
    /// </summary>
    ...
    /// <summary>
    /// Update Patient's Action Request with doc's response 
    /// </summary>
    ...
    /// <summary>
    /// Fetch all the information of a Doctor
    /// </summary>
    ...
    {
        //@"MATCH (a:Doctor {id: $docId}) DETACH DELETE a";
        var query = @"OPTIONAL MATCH (a:Doctor {id: $docId}) DETACH DELETE a
                    RETURN CASE 
